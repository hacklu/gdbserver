...
void gnu_fetch_registers_1 (struct target_ops *ops,
...
void store_fpregs (const struct regcache *regcache, struct proc *thread, int regno)
{
...
void gnu_store_registers_1 (struct target_ops *ops,
		struct regcache *regcache, int regno)
{
	struct proc *thread;
